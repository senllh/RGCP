...
parser.add_argument('--aug_ratio', type=float, default=0.3, help='argument ratio')
parser.add_argument('--batch_size', type=int, default=64, help='batch size')
parser.add_argument('--con_lr', type=float, default=0.001, help='learning rate')
parser.add_argument('--con_weight_decay', type=float, default=1e-4, help='weight decay') # 1e-4
...
parser.add_argument('--model_name', type=str, default='RGCP', help='')#Con_Gen_teach
# Structure refine
parser.add_argument("--if_GSL", type=bool, default=True, help="Default is True.")
parser.add_argument("--graph_type", type=str, default="KNN", help="epsilonNN, KNN, prob, sample1")
parser.add_argument("--graph_metric_type", type=str, default="weighted_cosine") # weighted_cosine, mlp, kernel, multi_mlp, transformer, gat_attention
parser.add_argument("--repar", type=bool, default=True, help="Default is True.")
parser.add_argument("--top_k", type=int, default=7, help="Default is 10.")
parser.add_argument("--graph_skip_conn", type=float, default=0.0, help="Default is 0.0.")
parser.add_argument("--num_per", type=int, default=4, help="Default is 16")
parser.add_argument("--epsilon", type=float, default=0.05, help="Default is 0.1.")
parser.add_argument("--feature_denoise", type=bool, default=True, help='True, False')
# pre-training
parser.add_argument('--pre_train', type=bool, default=False, help='True, False')

# Prompting
parser.add_argument('--downstream_task', type=str, default='prompting', help='prompting, fine_tuning')
parser.add_argument('--learnable_type', type=str, default='MLP', help='Multi_MLP, Multi_weight, attention, selfAttention, GCN, MLP')
parser.add_argument('--num_head', type=int, default='1', help='the numbe r of head ')
parser.add_argument('--prompt_answer_readout', type=str, default='mean', help='mean, max')
...
parser.add_argument("--cross_validation_task", type=bool, default=True, help="Default is False.")
